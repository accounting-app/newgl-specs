...
**Status:** Stage 5 in progress -- Group A (Register cluster) done (quickslike commits `20deea4`, `d9afd40`, branch `21-issue_ui_fixes_and_updates_dc`). Groups B-D not started.
